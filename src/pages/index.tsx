			...
			<div className={styles.container__oneSelf}>
				...
				<div className={styles.container__oneSelf__content}>
					...
					<span className={styles.c70}>
						...
						<br />
						その後、家族写真を通じて写真の魅力に目覚め、ライブイベント
						<br />
						フォトグラファーとしての道を歩み始めました。
						<br />
						東京、仙台、福島を中心に活動し、2019年に独立。2023年には
						<br />
						沖縄本島へ移住し、ウェディング専任のカメラマンとしての経験を
						<br />
						重ねました。2025年に再び独立し、2000組以上のカップルの
						<br />
						特別な瞬間を撮影してきました。
						<br />
						私の写真は、お二人の大切な時間をありのままに残すことを大切
						<br />
						にしています。
					</span>
				</div>
			...
			<div className={styles.container__reviews}>
				...
				<div className={styles.container__reviews__content}>
					...
					<p className={styles.container__reviews__content__main}>
						宮古島での旅行中、海のロケーションでウエディングフォトを撮影
						しました。口コミが高評価で、料金も納得できる内容だったので選
						びました。ドローン撮影やグリーンの撮影など、多様な撮影場所と
						方法があり、思い出に残る写真を残せて大満足です。TEDさんが親
						切に対応してくれたおかげで、期待以上の仕上がりとなりました。
					</p>
				</div>
				<div className={styles.container__reviews__content}>
					<div className={styles.container__reviews__content__hd}>
					...
					<p className={styles.container__reviews__content__main}>
						今回、沖縄の美しい海での撮影を希望し、評価の高いTEDさんにお
						願いしました！初めての宮古島訪問も魅力的で、離島を選べるオプ
						ションが大きなプラスでした！現地での撮影は期待以上の体験とな
						り、プロフェッショナルなサービスに大変満足しています。特別な
						瞬間を忘れられない思い出として残せました！！
					</p>
				</div>
				<div className={styles.container__reviews__content}>
					<div className={styles.container__reviews__content__hd}>
					...
					<p className={styles.container__reviews__content__main}>
						宮古ブルーの絶景で撮影ができ、大満足です！特にサンセットが素
						晴らしく、絶対に外せないビーチとサンセットの撮影に加えて、お
						すすめスポットも楽しめる贅沢なプランが魅力的でした。口コミ評
						価が高く、実際の写真も期待通り美しく、選んで本当に良かったで
						す！
					</p>
				</div>
				<div className={styles.container__reviews__content}>
					...
					<p className={styles.container__reviews__content__main}>
						宮古ブルーの美しいロケーションで撮影しました。そして、何より
						も圧巻だったのがサンセット！ビーチと夕日の組み合わせは絶対に
						外せません。さらに、プロのおすすめスポットが追加されたゴール
						ドプランを選びました！口コミの評判通り、仕上がった写真はどれ
						も素晴らしく、素敵な思い出になりました♪
					</p>
				</div>
			</div>
